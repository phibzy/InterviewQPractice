...
class Solution:
    def poorPigs(self, buckets, minutesToDie, minutesToTest):
        ...
        numTests = minutesToTest // minutesToDie + 1
        
        # The amount of pigs we need boils down to the equation (T+1) ^ x >= N
        # Solving for x we get x <= log(T+1) (N)
        # So to get the right integer answer we take the ceiling of the log result
        
        return math.ceil(math.log(buckets, numTests))
